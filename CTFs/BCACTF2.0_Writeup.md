...
> This challenge is a sequel to Movie-Login-1. However, this time, we are also provided wit# [BCACTF 2.0](https://play.bcactf.com/)<a name="bcactf-2"></a>
...
## [Go to Top](#bcactf-2)
h a denylist.json file. From the file, we know that the following characters are rejected in the input field and will yield an error message:  
`"1", "0", "/", "="`
